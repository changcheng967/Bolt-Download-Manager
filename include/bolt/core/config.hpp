...
constexpr std::uint64_t DEFAULT_SEGMENT_SIZE = 5'000'000;      // 5 MB initial
constexpr std::uint64_t MIN_SEGMENT_SIZE = 1'000'000;         // 1 MB
constexpr std::uint64_t MAX_SEGMENT_SIZE = 50'000'000;        // 50 MB
